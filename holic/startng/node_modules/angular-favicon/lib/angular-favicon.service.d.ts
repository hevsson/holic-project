 ...
 */
export declare class AngularFaviconService implements OnDestroy {
    private _doc;
    constructor(_doc: any);
    private darkScheme;
    private subscriptionToColorScheme;
     ...
     */
    setFavicon(iconURL: string, altIconURL?: string): void;
    /**
     ...
     * @param altIconURL - Optional, dark theme favicon URL
     */
    private subscribeToChangesInTheme;
    /**
     * Append new link to HEAD
     * @param link - DOM element
     * @param iconURL - favicon URL
     */
    private appendLinkTag;
    ngOnDestroy(): void;
}
